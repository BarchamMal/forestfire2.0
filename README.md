...
Enjoy the simulation and script, if you find any bugs, feel free to either make an [issue](https://github.com/BarchamMal/forestfire2.0/issues/new/choose) or fork the repo, fix it yourself and make a pull request.
